...
parser.add_argument('--tracks', type=str, default='/home/cvlab/Yuqi_CAGIC/python_project/GazeDeploy-master/speaker_detect/output_bak_20220824/pywork/012/tracks.pckl', help='Path to tracks files, produced by run_pipeline.py')
parser.add_argument('--video', type=str, default='/home/cvlab/Yuqi_CAGIC/python_project/GazeDeploy-master/data/videos/012.mp4', help='Path to original video')
parser.add_argument('--scores', type=str, default='/home/cvlab/Yuqi_CAGIC/python_project/GazeDeploy-master/speaker_detect/output_bak_20220824/pywork/012/whospeaks.npy', help='Path to the speaker scores file produced by get_speaker_score.py')
parser.add_argument('--out_video', type=str, default='/home/cvlab/Yuqi_CAGIC/python_project/GazeDeploy-master/face_maps_20220830/', help='Path and filename of the output video')
parser.add_argument('--maps_out', type=str, default='/home/cvlab/Yuqi_CAGIC/python_project/GazeDeploy-master/face_maps_20220830/', help='Output path and filename for saving face maps')
parser.add_argument('--bboxes_out', type=str, default='/home/cvlab/Yuqi_CAGIC/python_project/GazeDeploy-master/face_maps_20220830/', help='Output path and filename for saving face maps')
...
for frame in range(nframes):
	...
	for face in range(nfaces):
		...
		# print('----all faces bbox----:',frame_faces_boxes)
	...
	# imageio.imwrfite(name_non_speaker, non_speaker_map.astype('uint8')*255)
...
# print('face_boxes------',face_boxes)


np.save(opt.bboxes_out +video_fname+ '_faces_bboxes.npy', face_boxes)
np.save(opt.bboxes_out +video_fname+ '_frame_faces_boxes.npy', frame_faces_boxes)
